Pod::Spec.new do |s|
    ...
    s.name                = 'NielsenAppSDK-TD-XC'
    s.preserve_paths      = 'LICENSE.txt', 'pod_build_xc.sh'
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-dynamic/master/XC/Global-TD/NielsenAppSDK-9.2.0.0.zip' }
