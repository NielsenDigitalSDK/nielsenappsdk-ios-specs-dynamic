Pod::Spec.new do |s|
    ...
    s.name                = 'NielsenAGFTVOSAppSDK-TD'
    s.preserve_paths      = 'LICENSE.txt', 'pod_build.sh'
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-dynamic/master/tvOS/AGF-TD/NielsenAGFTVOSAppSDK-9.2.0.0.zip' }
