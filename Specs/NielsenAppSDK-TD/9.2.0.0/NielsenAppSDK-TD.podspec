Pod::Spec.new do |s|
    ...
    s.platform            = :ios, '12.0'
    s.name                = 'NielsenAppSDK-TD'
    s.preserve_paths      = 'LICENSE.txt', 'pod_build.sh'
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-dynamic/master/iOS/Global-TD/NielsenAppSDK-9.2.0.0.zip' }
